...
public class Auteur implements Serializable {
	...
	private void setApublie(ArrayList<Document> apublie) {
		this.apublie = apublie;
	}

	/**
	 * Ajoute le document à la liste des documents publiés par l'auteur Il
	 * demande aussi l'ajout de l'auteur à la liste d'auteur du document en
	 * question
	 * 
	 * @param document
	 *            à associé à l'auteur
	 */
