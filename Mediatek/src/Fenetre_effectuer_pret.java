...
public class Fenetre_effectuer_pret extends JFrame {
	...
	public Fenetre_effectuer_pret(Controleur_emprunt ce, Controleur_abonne ca,
		...
		btnValiderAbonn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (abonne != null) {
					lblTrouve.setText("Abonné : " + abonne.getNom() + " "
							+ abonne.getPrenom());
		...
		btnPreter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Document document;
				// le document existe et que le quota de l'abonné n'est pas
				// dépassé
				if (controleur_emprunt.verifEmprunt(refDoc, abonne)) {
					...
					JOptionPane.showMessageDialog(null, abonne.getPrenom()
							+ " " + abonne.getNom() + " " + " a emprunté "
							+ document.getTitre(), "Emprunt réussi",
